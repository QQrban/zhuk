...
export default function Contact() {
  ...
  return (
    <section id="contact" className="pt-20 px-10 relative overflow-hidden pb-1">
      ...
      <div className="max-w-[1350px] mx-auto relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-25 items-center justify-center">
          <div className="flex flex-col gap-8">
            {contacts.map(contact => (
              ...
              >
                ...
                <span className="text-xl sm:text-2xl md:text-3xl">{contact.text}</span>
              </a>
            ))}
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-yelloWW text-xl md:text-2xl text-right mt-8 font-medium max-w-md">
              Because being a freakin' culinary badass... <br /> is not an official job title!
            </p>
          </div>
        </div>
        ...
        <div className="mt-16 text-center text-gray-500 text-md flex items-center gap-1">
          ...
          <a target="_blank" href="https://www.linkedin.com/in/kurban-ramazanov-2b50b026b/">
            <CiLinkedin />
          </a>
        </div>
      </div>
